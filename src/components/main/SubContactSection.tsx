...
export default function ContactSection() {
  ...
  return (
    <section
    ref={ref}
    className="py-12 sm:py-16 lg:py-24 mt-12 sm:mt-20 mb-16 sm:mb-20 bg-black"
  >
    <motion.div
      variants={container}
      initial="hidden"
    ...
    >
      ...
      <motion.p
        variants={item}
        className="text-gray-300 mb-8 text-sm sm:text-base lg:text-lg leading-relaxed"
      >
        サッカーを始めたいけど不安…<br />
        もっと上手くなりたい！<br />
        その気持ちを全力でサポートします。<br />
      ...
      <motion.div variants={item} className="inline-block w-full sm:w-auto">
        <Button
          href="/contact"
